...
class TextEncoder(BaseModule):
    def __init__(self, n_vocab, n_feats, n_channels, filter_channels, 
                 ...
                 p_dropout, window_size=None, spk_emb_dim=64, n_spks=1,additional_feat=False):
        ...
        if self.additional_feat:
            self.additional_feat_func = torch.nn.Conv1d(n_channels, n_channels,1)
    ...
    def forward(self, x, x_lengths, spk=None):
        ...
        if self.additional_feat:
            additional_feat = self.additional_feat_func(x)
            return mu, logw, x_mask,additional_feat
        else:
